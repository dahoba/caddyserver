...
Caddy v2 customize to run on window nanoserver-1809

Below copied from [offical site](https://github.com/docker-library/docs/blob/master/caddy/README.md)
...
As for any pre-built image usage, it is the image user's responsibility to ensure that any use of this image complies with any relevant licenses for all software contained 